...
public class GlowshroomBlock extends BushBlock implements BonemealableBlock {
    public GlowshroomBlock(Properties properties) {
        super(properties.sound(SoundType.MOSS).strength(0.2f, 10f)
    ...
    private static final MapCodec<GlowshroomBlock> BLOCK_CODEC = simpleCodec(GlowshroomBlock::new);
...
//    }
    ...
    public boolean isValidBonemealTarget(LevelReader levelReader, BlockPos blockPos, BlockState blockState) {
        ...
        return mayPlaceOn(state, levelReader, blockPos);
    }
