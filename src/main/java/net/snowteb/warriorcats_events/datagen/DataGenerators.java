...
@EventBusSubscriber(modid = WarriorCatsEvents.MODID, bus = EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new ModRecipeProvider(generator.getPackOutput(), lookupProvider));
        ...
        generator.addProvider(event.includeServer(), new DatapackEntriesProvider(packOutput, lookupProvider));
