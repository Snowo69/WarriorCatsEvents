...
public class AncientStickItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (active) {
            tooltip.add(Component.literal("Right click to dismiss nearby cats").withStyle(ChatFormatting.GREEN));
        } else {
            tooltip.add(Component.literal("Right click to call nearby cats to follow").withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.literal("Right click + shift to call nearby cats to sit").withStyle(ChatFormatting.GRAY));
        }
    }
