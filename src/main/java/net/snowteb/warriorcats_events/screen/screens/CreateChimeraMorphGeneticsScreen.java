...
import net.snowteb.warriorcats_events.screen.widgets.VariantScrollList;
import net.snowteb.warriorcats_events.screen.widgets.GradientToggleButton;
import net.snowteb.warriorcats_events.screen.widgets.IntSliderButton;
...
//            this.baseChimeraVariantList.setRenderTopAndBottom(false);
            this.baseChimeraVariantList.setX(((centerX + 100)));
...
//            this.noiseList.setRenderTopAndBottom(false);
            this.noiseList.setX(((centerX - 160)));
...
//                silverVariantList.setVisible(true);
        ...
        entityToRender.setGeneticalVariants(storedVariants.eyeColorLeft, storedVariants.eyeColorRight, storedVariants.rufousingVariant, storedVariants.blueRufousingVariant,
                ...
                storedVariants.rightEyeVar, storedVariants.noise, storedVariants.size, storedVariants.silverVar, storedVariants.scars);
...
//                        centerX+90, centerY+115, 0xFFFFFFFF);
    ...
    private void back() {
        ...
        Minecraft.getInstance().setScreen(new CreateMorphGeneticsScreen(onGeneticalSkin, genetics, storedVariants, geneticsChimera, variantsChimera, this.isSummoning));
