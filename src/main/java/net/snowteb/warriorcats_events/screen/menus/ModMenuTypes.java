...
public class ModMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<HerbMixingMenu>> HERB_MIXING =
            registerMenuType("herb_mixing_menu", HerbMixingMenu::new);

    public static final DeferredHolder<MenuType<?>, MenuType<DockBackpackMenu>> DOCK_BACKPACK =
            registerMenuType("dock_backpack", DockBackpackMenu::new);
