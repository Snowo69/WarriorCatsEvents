...
//            }
        ...
        player.addEffect(new MobEffectInstance(ModEffects.SHARP_EYE, 1100, 0, true, false));
        player.addEffect(new MobEffectInstance(ModEffects.SHARP_SCENT, 300, 0, true, false));
