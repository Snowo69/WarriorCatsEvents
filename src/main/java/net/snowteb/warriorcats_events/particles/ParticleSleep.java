...
public class ParticleSleep extends SimpleAnimatedParticle {
    ...
    private ParticleSleep(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ, SpriteSet sprites) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new ParticleSleep(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
        }
    }
}