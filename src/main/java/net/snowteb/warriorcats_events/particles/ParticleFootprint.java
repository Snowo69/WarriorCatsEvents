...
public class ParticleFootprint extends TextureSheetParticle {
    ...
    public void render(VertexConsumer pBuffer, Camera pRenderInfo, float pPartialTicks) {
        ...
        if (Minecraft.getInstance().player != null) {
            if (!Minecraft.getInstance().player.hasEffect(ModEffects.SHARP_EYE)) {
                return;
            }
        }
        ...
        pBuffer.addVertex(vector0.x, vector0.y, vector0.z).setUv(u1, v0)
                .setColor(this.rCol, this.gCol, this.bCol, this.alpha)
                .setLight(light);

        pBuffer.addVertex(vector1.x, vector1.y, vector1.z).setUv(u1, v1)
                .setColor(this.rCol, this.gCol, this.bCol, this.alpha)
                .setLight(light);

        pBuffer.addVertex(vector2.x, vector2.y, vector2.z).setUv(u0, v1)
                .setColor(this.rCol, this.gCol, this.bCol, this.alpha)
                .setLight(light);

        pBuffer.addVertex(vector3.x, vector3.y, vector3.z).setUv(u0, v0)
                .setColor(this.rCol, this.gCol, this.bCol, this.alpha)
                .setLight(light);
