...
public class WCEServerConfig {
    ...
    public static class Server {
        ...
        public final ModConfigSpec.IntValue WILDCAT_WANDER_RADIUS;
        public final ModConfigSpec.IntValue KITTING_MINUTES;
        public final ModConfigSpec.IntValue KIT_GROWTH_MINUTES;
        public final ModConfigSpec.DoubleValue SKILL_COST_MULTIPLIER;
        public final ModConfigSpec.BooleanValue ENHANCED_ANIMALS;
        public final ModConfigSpec.BooleanValue COLORED_NAMES;
        public final ModConfigSpec.BooleanValue VISIBLE_MORPH_NAME;
        public final ModConfigSpec.BooleanValue LEAP_SERVER;
        public final ModConfigSpec.BooleanValue SKILL_TREE_SERVER;
        public final ModConfigSpec.BooleanValue VANILLA_MEAT_BONUS;
        public final ModConfigSpec.BooleanValue TELEPORT_WHEN_JOIN;
        public final ModConfigSpec.BooleanValue CAN_EAGLES_BE_TAMED;
        public final ModConfigSpec.BooleanValue THIRST;
        public final ModConfigSpec.BooleanValue DISEASES;

        public final ModConfigSpec.BooleanValue ENFORCE_TERRITORIES;
        public final ModConfigSpec.BooleanValue PROTECT_PLACE_AND_BREAK_BLOCKS;
        public final ModConfigSpec.BooleanValue PROTECT_CONTAINERS;
        public final ModConfigSpec.BooleanValue PUBLIC_CLAN_CREATION;

        public final ModConfigSpec.DoubleValue SKILL_SPEED_MULTIPLIER;
        public final ModConfigSpec.DoubleValue SKILL_HP_MULTIPLIER;
        public final ModConfigSpec.DoubleValue SKILL_DMG_MULTIPLIER;
        public final ModConfigSpec.DoubleValue SKILL_JUMP_MULTIPLIER;
        ...
        public final ModConfigSpec.DoubleValue TREE_STUMP_MULTIPLIER;
